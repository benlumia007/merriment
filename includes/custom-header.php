...
================================================================================================
*/
function merriment_custom_header_setup() {
    $args = array(
    ...
    'header-image' => array(
        ...
        'description'   => __( 'Header Image', 'merriment')
    )));
}
add_action('after_setup_theme', 'merriment_custom_header_setup');
