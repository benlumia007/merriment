...
================================================================================================
*/
function merriment_inline_styles_header_image_setup() {
        ...
        ";
        wp_add_inline_style('merriment-style', $custom_css);
}
add_action('wp_enqueue_scripts', 'merriment_inline_styles_header_image_setup');